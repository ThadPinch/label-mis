...
/// <summary>A flat, non-label charge on a sales order (die creation, design time, plates).
/// Charges are invoiced with the order and shown on the job ticket, but no production job
/// is ever scheduled for them.</summary>

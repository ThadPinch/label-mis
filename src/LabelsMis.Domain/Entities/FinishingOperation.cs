...
/// <summary>An off-press finishing step (laminate, die-cut, slit, rewind…) with its default setup,
/// speed and hourly cost. A die-cut task is generic: the die it runs with is chosen per product and
/// per estimate/order line, never on the task itself.</summary>

...
public class IndexModel(SupplierService supplierService, ICurrentUserService currentUser) : PageModel
{
    ...
    public PagedResult<SupplierListItem> Result { get; private set; } = null!;
    ...
    public async Task OnGetAsync(CancellationToken cancellationToken)
    {
        ...
        Result = await supplierService.ListAsync(Search, Sort, PageNumber, 20, IncludeInactive, cancellationToken);
    }
}

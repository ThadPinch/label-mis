...
namespace LabelsMis.Infrastructure.Migrations
{
    ...
    [Migration("20260922125044_PurgeSandboxTrackingEvents")]
    partial class PurgeSandboxTrackingEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LabelsMis.Domain.Entities.EmailLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LabelsMis.Domain.Entities.Job", b =>
                {
                    ...
                    b.Property<string>("ImposedArtworkFilePath")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<DateTime?>("ImposedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ImposedFromArtworkFilePath")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<bool>("ImposedIsManual")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("LabelsMis.Domain.Entities.Job", b =>
                {
                    ...
                    b.OwnsOne("LabelsMis.Domain.ValueObjects.ImpositionTemplate", "Imposition", b1 =>
                        {
                            b1.Property<Guid>("JobId")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<decimal>("BleedIn")
                                .HasPrecision(10, 4)
                                .HasColumnType("numeric(10,4)")
                                .HasColumnName("ImpositionBleedIn");

                            b1.Property<decimal>("CornerRadiusIn")
                                .HasPrecision(10, 4)
                                .HasColumnType("numeric(10,4)")
                                .HasColumnName("ImpositionCornerRadiusIn");

                            b1.Property<decimal>("CrossWebOffsetIn")
                                .HasPrecision(10, 4)
                                .HasColumnType("numeric(10,4)")
                                .HasColumnName("ImpositionCrossWebOffsetIn");

                            b1.Property<decimal>("EyeMarkHeightIn")
                                .HasPrecision(10, 4)
                                .HasColumnType("numeric(10,4)")
                                .HasColumnName("ImpositionEyeMarkHeightIn");

                            b1.Property<decimal>("EyeMarkWidthIn")
                                .HasPrecision(10, 4)
                                .HasColumnType("numeric(10,4)")
                                .HasColumnName("ImpositionEyeMarkWidthIn");

                            b1.Property<int>("EyeMarks")
                                .HasColumnType("integer")
                                .HasColumnName("ImpositionEyeMarks");

                            b1.Property<decimal>("GutterAcrossIn")
                                .HasPrecision(10, 4)
                                .HasColumnType("numeric(10,4)")
                                .HasColumnName("ImpositionGutterAcrossIn");

                            b1.Property<decimal>("GutterAroundIn")
                                .HasPrecision(10, 4)
                                .HasColumnType("numeric(10,4)")
                                .HasColumnName("ImpositionGutterAroundIn");

                            b1.Property<bool>("IncludeDieLines")
                                .HasColumnType("boolean")
                                .HasColumnName("ImpositionIncludeDieLines");

                            b1.Property<bool>("IncludeSlug")
                                .HasColumnType("boolean")
                                .HasColumnName("ImpositionIncludeSlug");

                            b1.Property<decimal>("LabelAcrossIn")
                                .HasPrecision(10, 4)
                                .HasColumnType("numeric(10,4)")
                                .HasColumnName("ImpositionLabelAcrossIn");

                            b1.Property<decimal>("LabelAroundIn")
                                .HasPrecision(10, 4)
                                .HasColumnType("numeric(10,4)")
                                .HasColumnName("ImpositionLabelAroundIn");

                            b1.Property<int>("LabelsAcross")
                                .HasColumnType("integer")
                                .HasColumnName("ImpositionLabelsAcross");

                            b1.Property<int>("LabelsAround")
                                .HasColumnType("integer")
                                .HasColumnName("ImpositionLabelsAround");

                            b1.Property<int>("Orientation")
                                .HasColumnType("integer")
                                .HasColumnName("ImpositionOrientation");

                            b1.Property<decimal>("WebWidthIn")
                                .HasPrecision(10, 4)
                                .HasColumnType("numeric(10,4)")
                                .HasColumnName("ImpositionWebWidthIn");

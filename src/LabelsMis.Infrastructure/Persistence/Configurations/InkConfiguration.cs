...
public class InkConfiguration : IEntityTypeConfiguration<Ink>
{
    public void Configure(EntityTypeBuilder<Ink> builder)
    {
        ...
        builder.Property(i => i.IsSpot).IsRequired();
        builder.Property(i => i.SpotColor);
        ...
        builder.Property(i => i.SpeedFpm1Hit).HasPrecision(10, 4);
        builder.Property(i => i.SpeedFpm2Hit).HasPrecision(10, 4);
        builder.Property(i => i.SpeedFpm3Hit).HasPrecision(10, 4);
